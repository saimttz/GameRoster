                ...
                <SafeAreaView style={styles.container}>
                    ...
                    <View style={styles.textEntree}>
                        ...
                        <View style={styles.textEnDeux}>
                            <Text style={styles.textEnDeuxTextUn}>Bienvenue à toi !
                            </Text>
                    ...
                    <View style={styles.inputBox}>
                        <View style={styles.inputsLogin}>
                            ...
                            <TextInput style={styles.inputLogin} placeholder='Confirmer votre Email' placeholderTextColor={"#414141"} />
                            <TextInput style={styles.inputLogin} placeholder='Mot de passe' placeholderTextColor={"#414141"} secureTextEntry={true} />
                            <TextInput style={styles.inputLogin} placeholder='Confirmez votre Mot de passe' placeholderTextColor={"#414141"} secureTextEntry={true} />
                        ...
                        <View style={styles.button}>
                            ...
                            <View style={styles.textSignUp}>
                                <Text style={styles.inscriptionTextePasEncore}>Déjà un compte ?</Text>
